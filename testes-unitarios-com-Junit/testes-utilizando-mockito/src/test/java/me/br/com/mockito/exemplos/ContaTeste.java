...
public class ContaTeste {
    ...
    void validaQuantidadeDeVezesQueMétodoFoiChamado() {
        ...
        // Mockito.verify(conta, Mockito.times(3)).validaSaldo(ArgumentMatchers.anyInt()); verifica a quantidade de vezes
        // chamadas com quaisquer valor inteiro > ArgumentMatchers.anyInt()
    }
}
