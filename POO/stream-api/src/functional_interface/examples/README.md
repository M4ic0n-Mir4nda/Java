...
public class ConsumerExample {
  public static void main(String[] args) {
    ...
    numeros.stream_api_desafios().forEach(imprimirNumeroPar);
  }
}
```
...
public class FunctionExample {
  public static void main(String[] args) {
    ...
    List<Integer> numerosDobrados = numeros.stream_api_desafios()
        .map(dobrar)
        .collect(Collectors.toList());
...
public class PredicateExample {
  public static void main(String[] args) {
    ...
    List<Integer> numerosPares = numeros.stream_api_desafios()
        .filter(isPar)
        .collect(Collectors.toList());
...
public class BinaryOperatorExample {
  public static void main(String[] args) {
    ...
    int resultado = numeros.stream_api_desafios()
        .reduce(0, somar);
